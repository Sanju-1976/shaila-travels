...
const vehicles = [
  {
    ...
    price: "₹12/km",
    perDay: "₹1,200/day",
    desc: "Comfortable and fuel-efficient sedan, perfect for city rides and short outstation trips.",
  },
  {
    id: 2, emoji: "🚙",
    ...
    price: "₹16/km",
    perDay: "₹1,800/day",
    desc: "Spacious 7-seater MPV ideal for family outings and group travel with ample luggage space.",
  },
  {
    id: 3, emoji: "🚐",
    ...
    price: "₹22/km",
    perDay: "₹2,800/day",
    desc: "Premium and powerful SUV for long highway trips. Superior comfort with powerful diesel engine.",
  },
  {
    id: 4, emoji: "🚌",
    ...
    price: "₹28/km",
    perDay: "₹4,500/day",
    desc: "Ideal for group tours, corporate trips, and pilgrimages. 12-seater with reclining seats.",
  },
  {
    id: 5, emoji: "🚌",
    ...
    price: "₹32/km",
    perDay: "₹5,500/day",
    desc: "Larger capacity for big groups. Push-back seats, large windows, and ample boot space.",
  },
  {
    id: 6, emoji: "🚗",
    name: "Swift Dzire (Non-AC)",
    type: "Sedan",
    category: "sedan",
    badge: "Budget",
    seats: "4 Seats",
    ...
    price: "₹9/km",
    perDay: "₹900/day",
    desc: "Budget-friendly option for short rides within the city. Clean and well-maintained.",
  },
];
...
const destinations = [
  ...
  { emoji: "🏖️", name: "Pondicherry", km: "310 km from Bengaluru", highlight: "French Riviera" },
];
...
export default function TravelAgency() {
  ...
  return (
    <>
      ...
      {/* NAVBAR */}
      <nav className="nav">
        <a className="nav-logo" href="#">Swift<span>Yatra</span> 🚗</a>
      ...
      <section id="home" className="hero">
        ...
        <div className="hero-content">
          <div className="hero-tag">🌍 Karnataka's Most Trusted Travel Partner</div>
          <h1>
            Travel Anywhere,
      ...
      <div className="search-wrap">
        <div className="search-bar">
          ...
          <button className="search-btn" onClick={() => scrollTo("fleet")}>🔍 Search</button>
        </div>
      </div>
          ...
          {filtered.map(car => (
            <div className="car-card" key={car.id}>
              ...
              <div className="car-info">
                ...
                <p style={{ color: "var(--muted)", fontSize: "0.85rem", lineHeight: "1.6", marginBottom: "14px" }}>{car.desc}</p>
                <div className="car-price">
                  <div>
                    <div className="price-amount">{car.price}</div>
                    <span className="price-unit">{car.perDay}</span>
                  </div>
                  <button className="book-btn" onClick={() => { setSelectedCar(car); setBooked(false); }}>Book Now →</button>
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="section why-bg">
        <div className="sec-head">
          ...
          <h2 className="sec-title">The SwiftYatra Promise</h2>
      ...
      <section className="section test-bg">
        <div className="sec-head">
          ...
          <h2 className="sec-title">What Our Travellers Say</h2>
        </div>
      ...
      <section id="contact" className="section">
        ...
        <div className="contact-wrap">
          <div>
            <div className="contact-item"><div className="c-icon">📍</div><div><h5>Office Address</h5><p>14, MG Road, Bengaluru, Karnataka 560001</p></div></div>
            <div className="contact-item"><div className="c-icon">📞</div><div><h5>Phone / WhatsApp</h5><p>+91 98765 43210</p></div></div>
            <div className="contact-item"><div className="c-icon">🚨</div><div><h5>Emergency / 24x7</h5><p>+91 80 9999 1234</p></div></div>
            <div className="contact-item"><div className="c-icon">✉️</div><div><h5>Email</h5><p>bookings@swiftyatra.in</p></div></div>
            <div className="contact-item"><div className="c-icon">🕐</div><div><h5>Working Hours</h5><p>24 Hours, 7 Days a Week</p></div></div>
          </div>
          <div className="contact-form">
            <div className="cf-row">
              <div className="cf-group"><label>Your Name</label><input placeholder="Ramesh Kumar" value={contact.name} onChange={e => setContact({...contact, name: e.target.value})} /></div>
              <div className="cf-group"><label>Phone</label><input placeholder="+91 98765 43210" value={contact.phone} onChange={e => setContact({...contact, phone: e.target.value})} /></div>
            </div>
            <div className="cf-group">
              <label>Preferred Vehicle</label>
              <select value={contact.vehicle} onChange={e => setContact({...contact, vehicle: e.target.value})}>
                <option value="">Select vehicle</option>
                {vehicles.map(v => <option key={v.id} value={v.name}>{v.name}</option>)}
              </select>
            </div>
            <div className="cf-group"><label>Message</label><textarea placeholder="Tell us about your trip — destination, dates, number of passengers..." value={contact.msg} onChange={e => setContact({...contact, msg: e.target.value})} /></div>
            <button className="cf-submit" onClick={handleCf}>Send Enquiry →</button>
            {cfSent && <div className="cf-success">✅ Enquiry sent! We'll call you back within 30 minutes.</div>}
          </div>
        </div>
      </section>
      ...
      <footer>
        <div className="footer-top">
          <div className="footer-brand">
            <div className="footer-logo">Swift<span>Yatra</span> 🚗</div>
            <p>Karnataka's most trusted travel partner. Comfortable rides, expert drivers, transparent pricing.</p>
          </div>
        ...
        <div className="footer-bottom">
          <p>© 2026 SwiftYatra. All rights reserved.</p>
